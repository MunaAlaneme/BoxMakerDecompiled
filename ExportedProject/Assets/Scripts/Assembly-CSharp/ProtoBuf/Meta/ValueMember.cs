...
namespace ProtoBuf.Meta
{
	...
	{
		internal sealed class Comparer : IComparer<ValueMember>, IComparer
		{
		...
		public string Name
		{
			get
			{
				return (!Helpers.IsNullOrEmpty(name)) ? name : member.Name;
			}
		}
		...
		private IProtoSerializer BuildSerializer()
		{
			...
			try
			{
				...
				IProtoSerializer protoSerializer = TryGetCoreSerializer(model, dataFormat, type, out defaultWireType, asReference, dynamicType, OverwriteList, true);
