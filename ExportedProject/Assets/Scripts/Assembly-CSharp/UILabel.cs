...
public class UILabel : UIWidget
{
	...
	[SerializeField]
	[HideInInspector]
	private Effect mEffectStyle = Effect.Outline8;

	[HideInInspector]
	[SerializeField]
	private Color mEffectColor = new Color(32f, 32f, 32f);
	...
	[HideInInspector]
	[SerializeField]
	private Color mEffectColor1 = new Color(32f, 32f, 32f);

	[SerializeField]
	[HideInInspector]
	private Vector2 mEffectDistance1 = new Vector2(2f, 2f);
	...
	private static void OnFontTextureChanged()
	{
		...
		for (int j = 0; j < mList.size; j++)
		{
			...
			if (uILabel2 != null)
			{
				Font font2 = uILabel2.trueTypeFont;
				if (font2 != null)
				{
	...
	protected override void OnStart()
	{
		...
		mEffectColor = new Color(0.0625f, 0.0625f, 0.0625f);
		mEffectDistance = new Vector2(1f, 1f);
		mEffectColor1 = new Color(0.1875f, 0.1875f, 0.1875f);
		mEffectDistance1 = new Vector2(2f, 2f);
		if (mLineWidth > 0f)
		{
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		if (effectStyle != 0)
		{
			...
			Vector2 vector2 = new Vector2(mEffectDistance1.x, mEffectDistance1.y);
			ApplyShadow1(verts, uvs, cols, num, size2, vector2.x, 0f - vector2.y);
