...
public class mario_goutou_big : mario_charater
{
	...
	private void go_die()
	{
		...
		list.Add(0);
		list.Add(0);
		mario_obj mario_obj2 = play_mode._instance.create_mario_obj_ex("mario_goutou", null, list, -1, -1, m_pos.x, m_pos.y + 400);
		mario_obj2.m_velocity.set(-40, 150);
		list = new List<int>();
		list.Add(1);
		list.Add(0);
		list.Add(0);
		list.Add(0);
		mario_obj mario_obj3 = play_mode._instance.create_mario_obj_ex("mario_goutou", null, list, -1, -1, m_pos.x, m_pos.y + 400);
		mario_obj3.m_velocity.set(40, 150);
	}
