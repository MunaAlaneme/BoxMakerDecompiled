...
{
	[Serializable]
	[ProtoContract(Name = "cmsg_view_video")]
	public class cmsg_view_video : IExtensible
	{
		...
		[ProtoMember(3, IsRequired = true, Name = "video_id", DataFormat = DataFormat.TwosComplement)]
		public int video_id
		{
			get
			{
